        ...
        <div class="row mb-2">
            <div class="col-md-6">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        <strong class="d-inline-block mb-2 text-primary-emphasis">Philippines</strong>
                        <h3 class="mb-0">Philippines Senate launches investigation into Duterte’s ICC arrest</h3>
                        <div class="mb-1 text-body-secondary">17 Mar 2025</div>
                        <p class="card-text mb-auto">The Philippines Senate has announced it will probe the arrest and
                            handover of former President Rodrigo Duterte to the International Criminal Court (ICC).</p>
                    </div>
                    <div class="col-auto d-none d-lg-block">
                        <img src="images/duterte.webp" width="200" height="250" alt="" srcset="">
            ...
            <div class="col-md-6">
                <div
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        <strong class="d-inline-block mb-2 text-primary-emphasis">Philippines</strong>
                        <h3 class="mb-0">Empowered women: Marian Rivera, Heart Evangelista, Bea Alonzo
                        </h3>
                        <div class="mb-1 text-body-secondary">15 Mar 2025</div>
                        <p class="card-text mb-auto">Top of mind among showbiz personalities are Marian Rivera, Heart
                            Evangelista, and Bea Alonzo who are not afraid to speak their minds.</p>                     
                    </div>
                    <div class="col-auto d-none d-lg-block">
                        <img src="images/woman.avif" width="200" height="250" alt="" srcset="">
                ...
                <div class="col-md-8">
                    ...
                    <article class="blog-post">
                        ...
                        <p>This is some additional paragraph placeholder content. It has been written to fill the
                            available
                            space
                            and show how a longer snippet of text affects the surrounding content. We'll repeat it often
                            to keep
                            the
                ...
                <div class="col-md-4">
                    <div class="position-sticky" style="top: 2rem;">
                        <div class="p-4 mb-3 bg-body-tertiary rounded">
                            <a href="index.php?about" class="text-decoration-none stretched-link">About</a>
                            <p class="mb-0">
